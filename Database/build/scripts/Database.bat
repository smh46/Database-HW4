...
set CLASSPATH=%APP_HOME%\lib\Database.jar;%APP_HOME%\lib\guava-20.0.jar

@rem Execute Database
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DATABASE_OPTS%  -classpath "%CLASSPATH%" App %CMD_LINE_ARGS%
